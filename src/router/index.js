...
const routes = [
	...
	},
	{
		...
		component: () => import('@/views/csmja/FolhetoDaCSMJA.vue'),
	},
	{
		path: '/competencies',
		name: 'competencies',
	...
	},
	{
		...
		component: () => import('@/views/MinisterialDiploma.vue'),
	},
	{
		path: '/decret_law',
		name: 'decret_law',
	...
	},
	{
		...
		component: () => import('@/views/Resolution.vue'),
	},
	{
		path: '/dispatchment',
		name: 'dispatchment',
	...
	},
	{
		...
		component: () => import('@/views/JurisPlenario.vue'),
	},
	{
		...
		component: () => import('@/views/Juris1Secao.vue'),
	},
	{
		...
		component: () => import('@/views/Juris2Secao.vue'),
	},
	{
		...
		component: () => import('@/views/Juris3Secao.vue'),
	},
	{
		path: '/sub_section',
		name: 'sub_section',
	...
	},
	{
		...
		component: () => import('@/views/Instructions_Recommendations.vue'),
	},
	{
	...
	},
	{
		...
		component: () => import('@/views/structure_functioning.vue'),
	},
	{
		...
		component: () => import('@/views/ReportAuditPerformance.vue'),
	},
	...
	},
	{
		...
		component: () => import('@/views/FolhetoDaJurisdicao.vue'),
	},
	{
	...
	{
		path: '/institution/:guid',
		name: 'institution-item',
		meta: {
			display: 'institution',
			parent: 'institution',
		},
		component: () => import('@/views/InstitutionItem.vue'),
	},
	{
	...
	},
	{
		...
		component: () => import('@/views/csmja/Publications.vue'),
	},
	{
		path: '/csmja/decret',
		name: 'csmja.decret',
	...
	},
	{
		...
		component: () => import('@/views/fiscal/tfcm/Home.vue'),
	},
	{
		path: '/tfpm/home',
		name: 'tfpm.home',
		...
		component: () => import('@/views/fiscal/tfpm/Home.vue'),
	},
	{
		path: '/tfps/home',
		name: 'tfps.home',
		...
		component: () => import('@/views/fiscal/tfps/Home.vue'),
	},
	{
		path: '/tfps/news',
		...
		component: () => import('@/views/fiscal/tfps/BlogList.vue'),
	},
	{
		path: '/tfps/blog',
		name: 'tfps.blog',
	...
	},
	{
		...
		component: () => import('@/views/fiscal/tfps/BlogItem.vue'),
	},
	{
		path: '/tfps/faq',
		name: 'tfps.faq',
		...
		component: () => import('@/views/fiscal/tfps/Faq.vue'),
	},
	{
		path: '/tfps/law',
		name: 'tfps.law',
		...
		component: () => import('@/views/fiscal/tfps/Law.vue'),
	},
	{
		path: '/tfps/decret',
		name: 'tfps.decret',
		...
		component: () => import('@/views/fiscal/tfps/Decret.vue'),
	},
	{
...

	{
		...
		component: () => import('@/views/fiscal/tfpm/BlogList.vue'),
	},
	{
		path: '/tfpm/blog',
		name: 'tfpm.blog',
	...
	},
	{
		...
		component: () => import('@/views/fiscal/tfpm/BlogItem.vue'),
	},
	{
		path: '/tfpm/faq',
		name: 'tfpm.faq',
		...
		component: () => import('@/views/fiscal/tfpm/Faq.vue'),
	},
	{
		path: '/tfpm/law',
		name: 'tfpm.law',
		...
		component: () => import('@/views/fiscal/tfpm/Law.vue'),
	},
	{
		path: '/tfpm/decret',
		name: 'tfpm.decret',
		...
		component: () => import('@/views/fiscal/tfpm/Decret.vue'),
	},
	{
		...
		component: () => import('@/views/fiscal/tfpm/Dispatchment.vue'),
	},

	{
		...
		component: () => import('@/views/fiscal/tfcm/BlogList.vue'),
	},
	{
		path: '/tfcm/blog',
		name: 'tfcm.blog',
	...
	},
	{
		...
		component: () => import('@/views/fiscal/tfcm/BlogItem.vue'),
	},
	{
		path: '/tfcm/faq',
		name: 'tfcm.faq',
		...
		component: () => import('@/views/fiscal/tfcm/Faq.vue'),
	},
	{
		path: '/tfcm/law',
		name: 'tfcm.law',
		...
		component: () => import('@/views/fiscal/tfcm/Law.vue'),
	},
	{
		path: '/tfcm/decret',
		name: 'tfcm.decret',
		...
		component: () => import('@/views/fiscal/tfcm/Decret.vue'),
	},
	{
		...
		component: () => import('@/views/fiscal/tfcm/Dispatchment.vue'),
	},
	...
	},
	{
		...
		component: () => import('@/views/fiscal/tfpm/Publications.vue'),
	},
	{
		...
		component: () => import('@/views/fiscal/tfcm/Publications.vue'),
	},
...

	{
		...
		component: () => import('@/views/aduaneiro/tadcm/BlogList.vue'),
	},
	{
		path: '/tadcm/blog',
		name: 'tadcm.blog',
	...
	},
	{
		...
		component: () => import('@/views/aduaneiro/tadcm/BlogItem.vue'),
	},
	{
		path: '/tadcm/faq',
		name: 'tadcm.faq',
		...
		component: () => import('@/views/aduaneiro/tadcm/Faq.vue'),
	},
	{
		path: '/tadcm/law',
		name: 'tadcm.law',
		...
		component: () => import('@/views/aduaneiro/tadcm/Law.vue'),
	},
	{
		path: '/tadcm/decret',
		name: 'tadcm.decret',
		...
		component: () => import('@/views/aduaneiro/tadcm/Decret.vue'),
	},
	{
		...
		component: () => import('@/views/aduaneiro/tadcm/Dispatchment.vue'),
	},
	{
		path: '/tadcm/home',
		name: 'tadcm.home',
		...
		component: () => import('@/views/aduaneiro/tadcm/Home.vue'),
	},

	{
		...
		component: () => import('@/views/aduaneiro/tadpn/BlogList.vue'),
	},
	{
		path: '/tadpn/blog',
		name: 'tadpn.blog',
	...
	},
	{
		...
		component: () => import('@/views/aduaneiro/tadpn/BlogItem.vue'),
	},
	{
		path: '/tadpn/faq',
		name: 'tadpn.faq',
		...
		component: () => import('@/views/aduaneiro/tadpn/Faq.vue'),
	},
	{
		path: '/tadpn/law',
		name: 'tadpn.law',
		...
		component: () => import('@/views/aduaneiro/tadpn/Law.vue'),
	},
	{
		path: '/tadpn/decret',
		name: 'tadpn.decret',
		...
		component: () => import('@/views/aduaneiro/tadpn/Decret.vue'),
	},
	{
		...
		component: () => import('@/views/aduaneiro/tadpn/Dispatchment.vue'),
	},
	{
		path: '/tadpn/home',
		name: 'tadpn.home',
		...
		component: () => import('@/views/aduaneiro/tadpn/Home.vue'),
	},
	{
		path: '/tadpz/home',
		name: 'tadpz.home',
...

	{
		...
		component: () => import('@/views/aduaneiro/tadps/BlogList.vue'),
	},
	{
		path: '/tadps/blog',
		name: 'tadps.blog',
	...
	},
	{
		...
		component: () => import('@/views/aduaneiro/tadps/BlogItem.vue'),
	},
	{
		path: '/tadps/faq',
		name: 'tadps.faq',
		...
		component: () => import('@/views/aduaneiro/tadps/Faq.vue'),
	},
	{
		path: '/tadps/law',
		name: 'tadps.law',
		...
		component: () => import('@/views/aduaneiro/tadps/Law.vue'),
	},
	{
		path: '/tadps/decret',
		name: 'tadps.decret',
		...
		component: () => import('@/views/aduaneiro/tadps/Decret.vue'),
	},
	{
		...
		component: () => import('@/views/aduaneiro/tadps/Dispatchment.vue'),
	},
	{
		path: '/tadps/home',
		name: 'tadps.home',
		...
		component: () => import('@/views/aduaneiro/tadps/Home.vue'),
	},
	{
		path: '/intranet',
		name: 'intranet',
		beforeEnter() {
			//window.open('https://intranet.ta.gov.mz', '_blank');
			// location.href = 'https://intranet.ta.gov' },
			location.href = 'https://intranet.ta.gov.mz';
		},
