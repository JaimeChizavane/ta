...
class FetchJurispudencia2SecaoCommand extends SPApiFetch
{
    protected $signature   = 'sp:jurispudencia2secao';
    protected $description = 'Fetch all jurispudencia 2 Seccao';
    /**
